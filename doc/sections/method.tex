...
\section{Method}
This section covers all the steps taken in order to create and evaluate the
classifer.
...
number of neurons in the hidden layer. When multiple classifiers has been
created, the one that performs the best on the validation set is selected and
used. The performance is measured by the percentage of correctly classified
digits, i.e. the average of the f1 score for all the classes.
